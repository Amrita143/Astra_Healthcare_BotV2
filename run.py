...
def start_initial_prompt():
    ...
    initial_prompt = (
        "You have some consumer information on file : consumer name John Smith ,US consumer (Georgia). balance 1200$ for medical bill, progressive emergency physicians bills , service date july 17,2019, SSN - XXX-XX-XX89, DOB - 27-03-XXXX. You are calling from 'Astra Global'for your client 'Account Reciveable Management'. Now, start conversation, Start the outbound call , conversation just started, \nConsumer : Hello ?"
    )
