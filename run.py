...
def start_initial_prompt():
    ...
    initial_prompt = (
        "Start conversation, Start the outbound call , conversation just started, You as debt collector has some "
        ...
        "service date july 17,2019, SSN - 123-45-6789, DOB - 27-03-1974. You are calling from 'Astra Global'for your client 'Account Reciveable Management'. \nConsumer : Hello ?"
    )
